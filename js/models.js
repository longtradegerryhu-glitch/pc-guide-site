...
,
    ...
    { id: "m8",  brand: "雷鸟",   model: "27U8A",             name: "雷鸟 27U8A", searchName: "雷鸟 27U8A", style: "27英寸 4K MiniLED", price: [1889, 2299], rating: 5, valueGrade: "S", valueNote: "4K MiniLED 双模，两千档画质守门员。",                 use: ["game", "create"], audience: ["gamer", "creator"], tags: ["MiniLED", "双模"], specs: "27英寸;4K 160Hz / 1080P 320Hz;MiniLED;HDR1000;95% DCI-P3", compat: "需 RTX 5070 级显卡跑 4K 高刷，游戏创作两用" },
    { id: "m9",  brand: "雷神",   model: "CU27F160M-EVO",     name: "雷神 CU27F160M-EVO", searchName: "雷神 CU27F160M-EVO", style: "27英寸 4K MiniLED", price: [2199, 2499], rating: 4, valueGrade: "A", valueNote: "1152 分区 MiniLED，HDR1000 亮度扎实。",              use: ["game", "create"], audience: ["gamer", "creator"], tags: ["MiniLED", "1152分区"], specs: "27英寸;4K 160Hz;1152 分区;HDR1000", compat: "4K 高刷入门甜点，配 5070 Ti 更稳" },
    { id: "m10", brand: "HKC",    model: "G27M7Pro",          name: "HKC G27M7Pro", searchName: "HKC G27M7Pro", style: "27英寸 4K MiniLED", price: [2399, 2699], rating: 4, valueGrade: "A", valueNote: "QD-MiniLED 双模，HDR1400 峰值亮度越级。",            use: ["game", "create"], audience: ["gamer", "creator"], tags: ["MiniLED", "HDR1400"], specs: "27英寸;4K 160Hz / 1080P 320Hz;QD-MiniLED;HDR1400", compat: "高亮度 HDR 观影与 3A 兼顾" },
    { id: "m11", brand: "AOC",    model: "AG276UZD",          name: "AOC AG276UZD", searchName: "AOC AG276UZD", style: "26.5英寸 2K OLED", price: [3299, 3699], rating: 4, valueGrade: "A", valueNote: "QD-OLED 360Hz 零拖影，竞技上限最高。",                 use: ["game"], audience: ["gamer"], tags: ["OLED", "高刷"], specs: "26.5英寸;2K 360Hz;QD-OLED;HDR400", compat: "纯竞技向，显卡压力低于 4K" },
    { id: "m12", brand: "微星",   model: "MAG321UPX QD-OLED", name: "微星 MAG321UPX", searchName: "微星 MAG321UPX", style: "32英寸 4K QD-OLED", price: [4199, 4599], rating: 4, valueGrade: "A", valueNote: "32 寸 4K QD-OLED 240Hz，桌面旗舰终端。",             use: ["create", "game"], audience: ["creator", "gamer"], tags: ["OLED", "旗舰", "4K"], specs: "31.5英寸;4K 240Hz;QD-OLED;0.03ms;Type-C", compat: "旗舰机一步到位，需 5080 级显卡喂满" },
  ],
...
,
    ...
    { id: "k8",  brand: "ROG",     model: "夜魔 X",             name: "ROG 夜魔 X", searchName: "ROG 夜魔 X", style: "三模机械键盘", price: [1849, 1999], rating: 5, valueGrade: "B", valueNote: "2 英寸 OLED 屏 + 全键热插拔，旗舰手感天花板。",     use: ["game", "create"], audience: ["gamer", "creator"], tags: ["旗舰", "OLED屏", "三模"], specs: "全键热插拔;2 英寸 OLED;冰暴灰轴 V2 / 雪武白轴 V2;三面透光", compat: "一步到位的主力键盘，客制化门槛低" },
    { id: "k9",  brand: "Keychron", model: "Q13 Ultra 8K",     name: "Keychron Q13 Ultra 8K", searchName: "Keychron Q13 Ultra 8K", style: "客制化机械键盘", price: [1601, 1899], rating: 5, valueGrade: "B", valueNote: "CNC 铝壳 + 96% Alice 配列，无线 8K 客制化成品。",   use: ["create", "office"], audience: ["creator", "office"], tags: ["客制化", "铝壳", "8K"], specs: "96% Alice 布局;CNC 铝合金;Gasket 六层填充;三模 8000Hz;660 小时续航", compat: "长时间码字/剪辑，肩腕更放松" },
    { id: "k10", brand: "ROG",     model: "龙鳞 2 Ace",        name: "ROG 龙鳞 2 Ace", searchName: "ROG 龙鳞 2 Ace", style: "无线鼠标", price: [909, 999], rating: 5, valueGrade: "B", valueNote: "48g 超轻 + AimPoint Pro 42K，8K 无线低延迟。",      use: ["game"], audience: ["gamer"], tags: ["旗舰", "轻量化", "8K"], specs: "48g;AimPoint Pro 42K;SpeedNova 8K 无线", compat: "FPS 硬核玩家，1 亿次按键寿命" },
    { id: "k11", brand: "罗技",    model: "MX Master 4",        name: "罗技 MX Master 4", searchName: "罗技 MX Master 4", style: "无线鼠标", price: [999, 1099], rating: 4, valueGrade: "B", valueNote: "生产力标杆，多设备切换与人机工学拉满。",            use: ["office", "create"], audience: ["creator", "office"], tags: ["生产力", "人体工学"], specs: "右手人体工学;多设备切换;高精度追踪", compat: "剪辑/编程/多机党效率工具，非纯电竞向" },
    { id: "k12", brand: "万灵竞记", model: "幻63",              name: "万灵竞记 幻63", searchName: "万灵竞记 幻63", style: "磁轴电竞键盘", price: [1799, 1799], rating: 4, valueGrade: "B", valueNote: "镁合金壳体 + 磁轴 0.001mm RT 精度。",               use: ["game"], audience: ["gamer"], tags: ["磁轴", "镁合金"], specs: "63 键;镁合金机身;8000Hz;磁轴 RT 0.001mm", compat: "纯竞技向，追求极致触发精度" },
  ],
...
,
  ...
  gpu: [
    ...
    { id: "g2", brand: "NVIDIA",    model: "RTX 5060 8G",            name: "NVIDIA RTX 5060 8G", searchName: "NVIDIA RTX 5060", style: "2K 入门", price: [2550, 3100],  rating: 5, valueGrade: "S", valueNote: "2K 入门甜点，DLSS4 加持。",                         use: ["game", "create"], audience: ["gamer", "student"], tags: ["DLSS", "高性价比"], specs: "8GB GDDR7;2K 中高画质;DLSS4", compat: "配 550-650W 电源，主流游戏机首选" },
    ...
    { id: "g4", brand: "NVIDIA",    model: "RTX 5070 12G",           name: "NVIDIA RTX 5070 12G", searchName: "NVIDIA RTX 5070", style: "2K 高刷", price: [6300, 7200],  rating: 5, valueGrade: "A", valueNote: "2K 全特效，DLSS4 帧生成；9 月京东非公已到 6799。",                        use: ["game", "create"], audience: ["gamer", "creator"], tags: ["DLSS4", "电竞"], specs: "12GB GDDR7;2K 全特效;DLSS4 帧生成", compat: "配 650-750W 电源，高帧电竞" },
    ...
    { id: "g6", brand: "NVIDIA",    model: "RTX 5070 Ti 16G",        name: "NVIDIA RTX 5070 Ti 16G", searchName: "NVIDIA RTX 5070 Ti", style: "创作旗舰", price: [8700, 10500],  rating: 5, valueGrade: "S", valueNote: "16G 显存，创作游戏双旗舰；较 618 涨约 60%。",                    use: ["create", "game"], audience: ["creator", "gamer"], tags: ["创作", "旗舰"], specs: "16GB GDDR7;4K 入门;NVENC 加速", compat: "配 750-850W 电源，创作旗舰" },
    { id: "g7", brand: "NVIDIA",    model: "RTX 5080 16G",           name: "NVIDIA RTX 5080 16G", searchName: "NVIDIA RTX 5080", style: "4K 旗舰", price: [12300, 16000], rating: 5, valueGrade: "A", valueNote: "4K 高刷顶配，AI 渲染利器；9 月封仓涨至 1.2 万起。",                       use: ["create", "game"], audience: ["creator"], tags: ["旗舰", "4K"], specs: "16GB GDDR7;4K 高刷;DLSS4", compat: "配 850-1000W 电源，顶配机" }
,
    ...
    { id: "g9",  brand: "NVIDIA",    model: "RTX 5060 Ti 16G",    name: "NVIDIA RTX 5060 Ti 16G", searchName: "NVIDIA RTX 5060 Ti", style: "2K 甜点", price: [5000, 6000], rating: 5, valueGrade: "A", valueNote: "16G 显存甜点，DLSS4 战未来；2026-09 已涨至 5000+。",         use: ["game", "create"], audience: ["gamer", "student"], tags: ["DLSS", "大显存"], specs: "16GB GDDR7;2K 高画质;DLSS4", compat: "配 650W 电源，主流游戏创作" },
    { id: "g10", brand: "NVIDIA",    model: "RTX 5090D 32G",    name: "NVIDIA RTX 5090D 32G", searchName: "NVIDIA RTX 5090D", style: "4K 终极旗舰", price: [39999, 45000], rating: 5, valueGrade: "C", valueNote: "32G 显存天花板，缺货溢价明显，非必需没必要上。", use: ["create", "game"], audience: ["creator"], tags: ["旗舰", "32G", "4K"], specs: "32GB GDDR7;4K 240Hz;DLSS4;AI 算力旗舰", compat: "需 1000W+ 电源与旗舰主板，理性看待溢价" },
  ]
};
